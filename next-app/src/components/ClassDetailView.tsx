        ...
        <div className="p-8 w-full">
            <header className="flex justify-between items-center mb-10">
                <div className="flex items-center gap-4">
                    <button onClick={() => router.back()} className="p-2 rounded-lg hover:bg-lime-50 transition-colors">
                ...
                <div className="p-8 pb-0 flex justify-between items-center">
                    <div className="flex gap-4">
                        {['Students', 'Assignments', 'Interests', 'Insights'].map((tab, i) => (
                            <button
                                key={tab}
                                className={`px-6 py-2 rounded-xl text-sm font-bold transition-all ${i === 0 ? 'bg-lime-100 text-lime-700' : 'text-gray-400 hover:bg-lime-50'
                                    }`}
                            >
                                {tab}
                            </button>
