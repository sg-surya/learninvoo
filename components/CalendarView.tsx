  ...
  return (
    <div className="p-8 h-full flex flex-col">
      ...
      <div className="flex gap-4 mb-8">
        {days.map((day, i) => (
          <div key={day} className={`flex-1 p-4 rounded-3xl text-center border transition-all cursor-pointer ${
            i === 2 ? 'bg-lime-900 border-lime-900 shadow-lg text-white' : 'bg-white border-gray-100 text-gray-800 hover:border-lime-200'
          }`}>
