...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-lime-500 selection:text-white w-full overflow-x-hidden">
      ...
      {/* Scroll Progress Bar */}
      <div className="fixed top-0 left-0 h-1 bg-lime-500 z-[1001] transition-all duration-150" style={{ width: `${scrollProgress}%` }} />

      {/* Background Pattern */}
      <div className="fixed inset-0 pointer-events-none z-0 opacity-30 bg-dot-pro"></div>
